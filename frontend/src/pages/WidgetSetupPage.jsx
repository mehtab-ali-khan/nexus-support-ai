...
export function WidgetSetupPage() {
    ...
    return (
        <div className="max-w-2xl mx-auto px-4 sm:px-6 py-10">
            ...
            <div className="my-5 border border-[var(--g-300)] rounded-[var(--radius-lg)] overflow-hidden">
            ...
            <div className="mt-5 flex items-center justify-between gap-4 px-5 py-4 rounded-[var(--radius-lg)] bg-[var(--p-soft)] border border-[var(--p)]">
                <div>
